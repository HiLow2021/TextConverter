...
namespace TextConverter.Models
{
    public static class TextDetector
    {
        ...
        public static Encoding DetectEncodingWithBom(byte[] bytes)
        {
            if (bytes.Length < 2)
            {
                return null;
        ...
        /// </summary>
        /// <remarks>
        /// Jcode.pm の getcode メソッドを移植したものです。
        ...
        /// </remarks>
        /// <param name="bytes">文字コードを調べるデータ</param>
        /// <returns>適当と思われる <see cref="Encoding"/> オブジェクト。判断できなかった時はnull。</returns>
        public static Encoding DetectEncodingWithoutBom(byte[] bytes)
        {
            ...
            Console.WriteLine(string.Format("sjis = {0}, euc = {1}, utf8 = {2}", sjis, euc, utf8));
