...
using TextConverter.WPF.Views;

namespace TextConverter.WPF
{
    /// <summary>
    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void OnInitialized()
        {
            ...
            regionManager.RegisterViewWithRegion("MainWindowContentRegion", typeof(RegexView));
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            {
                var data = FileAdvanced.LoadFromBinaryFile<string>(MyAppSettings.ConfigPath);

                Settings = DataSerializer.FromXmlToObject<MyAppSettings>(data, MyAppSettings.KnownTypes);
            }
            else
            {
        ...
        private void MainWindow_Closing(object sender, EventArgs e)
        {
            ...
            var data = DataSerializer.FromObjectToXml(Settings, MyAppSettings.KnownTypes);
